...
public class JDTelefonoListener implements ActionListener{
    ...
    public void limpiar(){
        jdT.getTxtNumero1().setText("");
        jdT.getTxtNumero2().setText("");
        jdT.getCbOperadora1().setSelectedIndex(0);
        jdT.getCbOperadora2().setSelectedIndex(0);
        jdT.setLstTelefonos(null);
        jdT.revalidate();
        jdT.repaint();
    }
    /**
    ...
    */
    private void addListeners(){
        jdT.getBtnAgregar().addActionListener(this);
        jdT.getBtnCerrar().addActionListener(this);
    }
}
