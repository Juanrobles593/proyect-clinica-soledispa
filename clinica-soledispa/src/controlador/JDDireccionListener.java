...
public class JDDireccionListener implements ActionListener {
    ...
    /**
     * Limpia todos elementos del Panel de telefonos
     */
    public void limpiar(){
        jdD.getTxtCiudad1().setText("");
        jdD.getTxtCiudad2().setText("");
        jdD.getTxtCalle1().setText("");
        jdD.getTxtCalle2().setText("");
        jdD.getTxtNumero1().setText("");
        jdD.getTxtNumero2().setText("");
        jdD.setLstDirecciones(null);
        jdD.revalidate();
        jdD.repaint();
    }
    /**
     * Añade escuchadores a los botones.
     */
    public void addListeners(){
        jdD.getBtnGuardar().addActionListener(this);
        jdD.getBtnCerrar().addActionListener(this);
    }
}
