...
public class Enfermero extends Persona implements Serializable{
     ...
     */
    public Enfermero(String cedula, String nombre, String apellidos, String email, modelo.recursos.TipoSangre TipoSangre,EstadoCivil estadoCivil, Telefono[] telefonos, Direccion[] direcciones) {    
